    ...
    for line in lines:
        ...
        for op in ['+','-','*','/']:
            if op in line:
                ...
                if op == '+':
                    ymc.append(f"add {dest}, {left.strip()}, {right.strip()}")
                elif op == '-':
                    ymc.append(f"sub {dest}, {left.strip()}, {right.strip()}")
                elif op == '*':
                    ymc.append(f"mult {dest}, {left.strip()}, {right.strip()}")
                elif op == '/':
                    ymc.append(f"div {dest}, {left.strip()}, {right.strip()}")
                break
